...
#+BEGIN_SRC python
  .clickselect(extend=False, column=False)
#+END_SRC
...
** Add a Camera Preset
#+BEGIN_SRC python
  .preset_add(name="", remove_active=False)
#+END_SRC
* bpy.ops.clip
** Add a Clip Track Color Preset
#+BEGIN_SRC python
  .track_color_preset_add(name="", remove_active=False)
#+END_SRC
** Add a Tracking Camera Intrinsics  Preset
#+BEGIN_SRC python
  .camera_preset_add(name="", remove_active=False)
#+END_SRC
** Add a motion tracking settings preset
#+BEGIN_SRC python
  .tracking_settings_preset_add(name="", remove_active=False)
#+END_SRC
...
#+BEGIN_SRC python
  .track_markers(backwards=False, sequence=False)
#+END_SRC
...
#+BEGIN_SRC python
  .primitive_bezier_circle_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
** Construct a Bezier Curve
#+BEGIN_SRC python
  .primitive_bezier_curve_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
** Construct a Nurbs Circle
#+BEGIN_SRC python
  .primitive_nurbs_circle_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
** Construct a Nurbs Curve
#+BEGIN_SRC python
  .primitive_nurbs_curve_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
** Construct a Path
#+BEGIN_SRC python
  .primitive_nurbs_path_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
...
#+BEGIN_SRC python
  .fbx(filepath="", check_existing=True, filter_glob="*.fbx", use_selection=False, global_scale=1, axis_forward='-Z', axis_up='Y', object_types={'EMPTY', 'CAMERA', 'LAMP', 'ARMATURE', 'MESH'}, use_mesh_modifiers=True, mesh_smooth_type='FACE', use_mesh_edges=False, use_armature_deform_only=False, use_anim=True, use_anim_action_all=True, use_default_take=True, use_anim_optimize=True, anim_optimize_precision=6, path_mode='AUTO', use_rotate_workaround=False, xna_validate=False, batch_mode='OFF', use_batch_own_dir=True, use_metadata=True)
#+END_SRC
* bpy.ops.file
...
#+BEGIN_SRC python
  .sunsky_preset_add(name="", remove_active=False)
#+END_SRC
* bpy.ops.lattice
...
#+BEGIN_SRC python
  .sss_preset_add(name="", remove_active=False)
#+END_SRC
** Add a new material
#+BEGIN_SRC python
  .new()
...
#+BEGIN_SRC python
  .duplicate_metaelems(mode='TRANSLATION')
#+END_SRC
...
** Add a torus mesh
#+BEGIN_SRC python
  .primitive_torus_add(view_align=False, location=(0, 0, 0), rotation=(0, 0, 0), major_radius=1, minor_radius=0.25, major_segments=48, minor_segments=12, use_abso=False, abso_major_rad=1, abso_minor_rad=0.5)
#+END_SRC
...
#+BEGIN_SRC python
  .symmetrize(direction='NEGATIVE_X')
#+END_SRC
...
#+BEGIN_SRC python
  .bridge_edge_loops(type='SINGLE', use_merge=False, merge_factor=0.5, number_cuts=0, interpolation='PATH', smoothness=1, profile_shape_factor=0, profile_shape='SMOOTH')
#+END_SRC
...
#+BEGIN_SRC python
  .quads_convert_to_tris(use_beauty=True)
#+END_SRC
...
#+BEGIN_SRC python
  .node_color_preset_add(name="", remove_active=False)
#+END_SRC
...
#+BEGIN_SRC python
  .add_node(settings=[], use_transform=False, type="")
#+END_SRC
** Add a node to the active tree
#+BEGIN_SRC python
  .add_search(settings=[], use_transform=False, type="", node_item='<UNKNOWN ENUM>')
#+END_SRC
** Add a node to the active tree and link to an existing socket
#+BEGIN_SRC python
  .add_and_link_node(settings=[], use_transform=False, type="", link_socket_index=0)
#+END_SRC
** Add a reroute node
#+BEGIN_SRC python
...
#+BEGIN_SRC python
  .new_node_tree(type='CompositorNodeTree', name="NodeTree")
#+END_SRC
...
#+BEGIN_SRC python
  .metaball_add(type='BALL', view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
...
#+BEGIN_SRC python
  .cycles_integrator_preset_add(name="", remove_active=False)
#+END_SRC
...
** Render active scene
#+BEGIN_SRC python
  .render(animation=False, write_still=False, layer="", scene="")
#+END_SRC
...
#+BEGIN_SRC python
  .primitive_nurbs_surface_circle_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
** Construct a Nurbs surface Curve
#+BEGIN_SRC python
  .primitive_nurbs_surface_curve_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
** Construct a Nurbs surface Cylinder
#+BEGIN_SRC python
  .primitive_nurbs_surface_cylinder_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
** Construct a Nurbs surface Patch
#+BEGIN_SRC python
  .primitive_nurbs_surface_surface_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
** Construct a Nurbs surface Sphere
#+BEGIN_SRC python
  .primitive_nurbs_surface_sphere_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
** Construct a Nurbs surface Torus
#+BEGIN_SRC python
  .primitive_nurbs_surface_torus_add(view_align=False, enter_editmode=False, location=(0, 0, 0), rotation=(0, 0, 0), layers=(False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
#+END_SRC
* bpy.ops.text
...
#+BEGIN_SRC python
  .resize(value=(1, 1, 1), constraint_axis=(False, False, False), constraint_orientation='GLOBAL', mirror=False, proportional='DISABLED', proportional_edit_falloff='SMOOTH', proportional_size=1, snap=False, snap_target='CLOSEST', snap_point=(0, 0, 0), snap_align=False, snap_normal=(0, 0, 0), texture_space=False, release_confirm=False)
#+END_SRC
** Scale selected vertices' skin radii
#+BEGIN_SRC python
  .skin_resize(value=(1, 1, 1), constraint_axis=(False, False, False), constraint_orientation='GLOBAL', mirror=False, proportional='DISABLED', proportional_edit_falloff='SMOOTH', proportional_size=1, snap=False, snap_target='CLOSEST', snap_point=(0, 0, 0), snap_align=False, snap_normal=(0, 0, 0), texture_space=False, release_confirm=False)
#+END_SRC
...
#+BEGIN_SRC python
  .translate(value=(0, 0, 0), constraint_axis=(False, False, False), constraint_orientation='GLOBAL', mirror=False, proportional='DISABLED', proportional_edit_falloff='SMOOTH', proportional_size=1, snap=False, snap_target='CLOSEST', snap_point=(0, 0, 0), snap_align=False, snap_normal=(0, 0, 0), texture_space=False, release_confirm=False)
#+END_SRC
...
#+BEGIN_SRC python
  .keyconfig_preset_add(name="", remove_active=False)
#+END_SRC
** Add a theme preset
#+BEGIN_SRC python
  .interface_theme_preset_add(name="", remove_active=False)
#+END_SRC
** Add an Application Interaction Preset
#+BEGIN_SRC python
  .interaction_preset_add(name="", remove_active=False)
#+END_SRC
** Add an Operator Preset
#+BEGIN_SRC python
  .operator_preset_add(name="", remove_active=False, operator="")
#+END_SRC
** Add key map item
#+BEGIN_SRC python
  .keyitem_add()
...
#+BEGIN_SRC python
  .radial_control(data_path_primary="", data_path_secondary="", use_secondary="", rotation_path="", color_path="", fill_color_path="", zoom_path="", image_id="")
#+END_SRC
