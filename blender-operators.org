...
#+END_SRC
** The list is not displayed completely
#+BEGIN_SRC python
  .fake_button()
#+END_SRC
...
** simplify
#+BEGIN_SRC python
  .simplify(mode='DISTANCE', output='INPUT', k_thresh=0, pointsNr=5, error=0, degreeOut=5, dis_error=0, keepShort=True)
#+END_SRC
* bpy.ops.cycles
...
#+BEGIN_SRC python
  .raw(check_existing=True, filepath="", filter_glob="*.raw", apply_modifiers=True, triangulate=True)
#+END_SRC
* bpy.ops.file
...
** simplify
#+BEGIN_SRC python
  .simplify(mode='DISTANCE', k_thresh=0, pointsNr=5, error=0, degreeOut=5, dis_error=0)
#+END_SRC
* bpy.ops.group
...
** Add a torus mesh
#+BEGIN_SRC python
  .primitive_torus_add(rotation=(0, 0, 0), location=(0, 0, 0), view_align=False, major_radius=1, minor_radius=0.25, major_segments=48, minor_segments=12, use_abso=False, abso_major_rad=1, abso_minor_rad=0.5)
#+END_SRC
...
#+BEGIN_SRC python
  .add_node(type="", use_transform=False, settings=[])
#+END_SRC
** Add a node to the active tree
#+BEGIN_SRC python
  .add_search(type="", use_transform=False, settings=[], node_item='<UNKNOWN ENUM>')
#+END_SRC
** Add a node to the active tree and link to an existing socket
#+BEGIN_SRC python
  .add_and_link_node(type="", use_transform=False, settings=[], link_socket_index=0)
#+END_SRC
** Add a reroute node
#+BEGIN_SRC python
